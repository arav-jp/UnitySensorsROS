    ...
    if (this._timeElapsed > (1f / this._ground_truth.updateRate))
      {
        ...
        // Position
        Vector3<FLU> position_ros = new Vector3<FLU>(this._ground_truth.GeometryEuclidean).To<FLU>();
        ...
        // Rotation
        Quaternion<FLU> orientation_ros = new Quaternion<FLU>(this._ground_truth.GeometryQuaternion).To<FLU>();
